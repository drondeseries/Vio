...
func (h *WatchTogetherHandler) StageWatchTogetherItem(ctx context.Context, room string, user int, profile string, input watchtogether.SelectItemInput) (watchtogether.Snapshot, string, error) {
	...
	snapshot, err := h.Service.StageItem(ctx, room, user, profile, input)
	if err != nil {
