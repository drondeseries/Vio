...
func (h *WatchTogetherHandler) StopWatchTogetherPlayback(ctx context.Context, room string, user int, profile string) (watchtogether.Snapshot, string, error) {
	...
	snapshot, err := h.Service.StopPlaybackOnce(ctx, room, user, profile)
	if err != nil {
