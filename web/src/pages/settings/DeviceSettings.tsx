...
/**
 * "Your devices" — see and change how Vio behaves on each device you watch on.
 *
    ...
    <div className="space-y-4">
        ...
        >
          <div>
            ...
            <p className="text-muted-foreground mt-1 text-[13px] leading-relaxed">
              Device controls stay unavailable until Vio confirms which settings this server
              supports.
            </p>
          </div>
          <Button
      ...
      {forSomeoneElse ? (
        <Callout tone="muted" icon={<ShieldCheck className="h-4 w-4" />}>
          ...
          This page shows how Vio is set up on each device — not what anyone watched. Viewing
