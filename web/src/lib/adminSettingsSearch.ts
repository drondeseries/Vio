...
export const ADMIN_SETTINGS_GROUPS: AdminSettingsSearchGroup[] = [
  {
    ...
    items: [
      ...
      },
      {
        id: "streaming",
        label: "Streaming",
        description: "Stremio provider, virtual libraries, and quality profiles.",
        groups: ["Stremio provider", "Virtual libraries", "Quality"],
        keywords: [
          "stremio",
          "streaming",
          "manifest",
        ...
        settings: settingIndex(
          ...
          "TMDB API key",
          "Network access",
          "Allow HTTP for local manifests",
          "Allow private network streams",
          "Virtual libraries",
          "Movies library ID",
          "Series library ID",
          "Monitor file",
